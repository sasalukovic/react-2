  ...
  return (
    <>
      ...
      <Main>
        ...
        {/* Ovako moze preko children propertyja da se prosledjuje state */}
        {/* <Box> */}
...
const Box = ({ isLoading, error, children }) => {
...
const SelectedMovie = ({
  ...
  useEffect(() => {
    ...
    // because of Closure cleanup func remember title (title has set before the cleanup func)
